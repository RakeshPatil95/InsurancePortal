...
import CustomerPolicies from './admincustomers';
...
const AdminDashBoard = () => {
  ...
  return (
    ...
    <Card.Body>
     ...
     <Card.Footer> <Link to='/admincustomers' className='btn '>View Details</Link></Card.Footer>
  </Card>
		</Col>
		<Col className='col-6'>
	...
	<Card.Footer> <Link to='/adminagents' className='btn '>View Details</Link></Card.Footer>
  </Card>
		</Col>
		</Row>
		<Row>
	...
	<Card.Footer> <Link to='/adminAddPolicy' className='btn '>View Details</Link></Card.Footer>
  </Card>
		</Col>
		<Col className='col-6'>
	...
	<Card.Footer> <Link to='/totalbusiness' className='btn '>View Details</Link></Card.Footer>
  </Card>
		</Col>
		</Row>
      </div>

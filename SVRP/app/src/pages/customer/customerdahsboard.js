...
const CustomerDashBoard = () => {
  ...
  return (
    ...
    <Card.Body>
     ...
     <Card.Footer> <Link to='/customerpolicies' className='btn '>View Details</Link></Card.Footer>
  </Card>
		</Col>
		<Col className='col-6'>
	...
	<Card.Footer> <Link to='/customerprofile' className='btn '>View Details</Link></Card.Footer>
  </Card>
		</Col>
		<Col className='col-6'>
	...
	<Card.Footer> <Link to='/customerallplans' className='btn '>View Details</Link></Card.Footer>
  </Card>
		</Col>
		</Row>
    <Footer/>
